...
static void F407_GPIO_Init(void);
...
static void F411RE_GPIO_Init(void);

uint8_t STM32_Init(void)
{
	uint8_t retVal = SystemClock_Config();
	F411RE_GPIO_Init();
	return retVal;
}
...
static void F411RE_GPIO_Init(void)
{
	...
	// PB1 - Column1 ; PB15 - Column2 ; PB14 - Column3 ; PB13 - Column4 ;
	...
	// PC9 - Echo od ultrasound, PC7 - Row 3;
